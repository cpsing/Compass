...
function EmptyState() {
  return (
    <div className="rounded-lg border border-dashed border-gray-800 bg-gray-950 p-10 text-center">
      ...
      <div className="text-xs text-gray-600 mt-3">
        Quick demo:{' '}
        <code className="mono bg-gray-900 px-1 py-0.5 rounded">npm run seed:demo</code>
      </div>
    </div>
  );
}
